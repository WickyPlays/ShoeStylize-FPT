...
public class SearchServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] products = {"Urban Elegance: High-Top Sneakers\n", "Retro Cool: Vintage High-Tops\n" + "Sleek Minimalism: White Canvas Low-Tops\n"
            + "", "Casual Elegance: Navy Blue Low-Tops\n"
            + "", "Versatile Charm: Brown Leather Boots\n"
            + "", "Adventure-Ready: Waterproof Hiking Boots\n"
            + ""};
        ...
        for (String product : products) {
            if (product.toLowerCase().contains(keyword)) {
                ...
                out.println("<a href='details?product=" + product + "'>" + product + "</a>");
                out.println("</div>");
            }
        }
    }
