...
@WebServlet(name = "api-register-google", urlPatterns = {"/api/register-google"})
public class ApiRegisterGoogle extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (progressed) {
                dao.signup(username, firstname, lastname, email, password, address, dob, phone, city, state, "customer", "google");
