...
<div>
    <table id="order-table-progressing" class="stripe">
        <thead>
        <tr>
            <th>ID</th>
            <th>Image</th>
        ...
        <tbody>
        <c:forEach items="${ORDERS_PROGRESSING}" var="Order">
            <tr>
                <td>${Order.getId()}</td>
                ...
                <td>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#modal-status-progressing-${Order.getId()}">
                        Change
                    </button>

                    <div class="modal fade" id="modal-status--progressing-${Order.getId()}" tabindex="-1"
                            ...
                            <div class="modal-content">
                                <form method="POST"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="#order-sp-msg-${Order.getId()}" class="form-label">Note for this
                                                order:</label>
                                            <textarea name="order-sp-note" class="form-control"
                                                      placeholder="Enter your note here">${Order.getServiceProviderNote()}</textarea>
                                        </div>
                                    </div>
