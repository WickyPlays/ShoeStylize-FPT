...
<div>
    <table id="order-table-cancelled" class="stripe">
        <thead>
        <tr>
            <th>ID</th>
            <th>Image</th>
        ...
        <tbody>
        <c:forEach items="${ORDERS_CANCELLED}" var="Order">
            <tr>
                <td>${Order.getId()}</td>
                ...
                <td>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#modal-status-cancelled-${Order.getId()}">
                        Change
                    </button>

                    <div class="modal fade" id="modal-status-cancelled-${Order.getId()}" tabindex="-1"
