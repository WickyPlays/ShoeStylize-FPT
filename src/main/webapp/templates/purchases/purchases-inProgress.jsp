...
<table id="purchases-table-inProgress" class="stripe">
    <thead>
    <tr>
        <th>No.</th>
        <th>Image</th>
    ...
    <tbody>
    <c:forEach items="${LIST_PROGRESS_ORDERS}" var="Order">
        <tr>
            <td>${Order.getId()}</td>
            ...
            <td>
                ...
                <div>
                    <button type="button" class="btn btn-wide btn-danger" data-bs-toggle="modal" data-bs-target="#modal-all-cancel-${Order.getId()}">
                        Cancel
                    </button>

                    <div class="modal fade" id="modal-all-cancel-${Order.getId()}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form method="POST" action="${pageContext.request.contextPath}/api/order-edit/cancel">
